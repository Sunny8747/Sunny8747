...
- 언리얼 엔진 5 클라이언트/플랫폼 개발자로 근무하면서, SDK 적용부터 에셋 다운로드 및 패치 시스템, 클라이언트 실시간 네트워크 유지보수 등 다양한 핵심 개발에 주도적으로 참여하였습니다. 
특히, 캐나다와 한국 서로 다른 국가의 퍼블리셔 변경에 따른 두 차례의 SDK 적용 작업과 협업 개발 경험은 차별화된 강점으로, 새로운 환경에서도 빠르게 적응하고 안정적인 서비스 환경 구축을 할 수 있습니다.
